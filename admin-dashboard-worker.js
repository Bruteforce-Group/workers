// Cloudflare Worker for Admin Dashboard Test Application
// Domain: admin-test.bozza.au
// Policy: Admin - Full Access with MFA (Tier 3)
...
<head>
    ...
    <title>🔐 Admin Dashboard - Access Policy Test</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="tier-badge">TIER 3 - HIGH SECURITY</div>
            <p>If you can see this page, you successfully authenticated through Cloudflare Access!</p>
        </div>
        
        <div class="security-info">
            <h3>🛡️ Security Policy Applied</h3>
            <ul>
                <li><strong>Policy:</strong> Admin - Full Access with MFA</li>
                ...
                <li><strong>Group Required:</strong> Admins - Full Access</li>
            </ul>
        </div>
        ...
        <div class="info-grid">
            ...
            <div class="status-card">
                ...
                <p><strong>Session Expires:</strong> ${new Date(Date.now() + 2*60*60*1000).toLocaleString()}</p>
                <p><strong>Policy Tier:</strong> 3 (Admin)</p>
            </div>
            
            <div class="status-card">
                <h4>🔧 Technical Details</h4>
                <p><strong>Worker:</strong> admin-dashboard-test</p>
        ...
        <div class="security-info">
            ...
            <ul>
                ...
                <li>✓ User is a member of the Admin group</li>
                <li>✓ Request originated from Australia</li>
                <li>✓ JumpCloud SAML has been removed</li>
                <li>✓ Session timeout is set to 2 hours</li>
            </ul>
        </div>
        
        <footer class="timestamp">
            <p>Access Policy Test Server | Generated at ${new Date().toISOString()}</p>
        </footer>
    </div>
</body>
</html>`;
